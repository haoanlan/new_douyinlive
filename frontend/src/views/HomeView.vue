                  ...
                  <div style="flex:1;min-height:0;display:flex;flex-direction:column">
                    ...
                    <div id="rtDanmakuWrap" class="rt-danmaku-wrap" style="flex:1;display:flex;flex-direction:column;overflow:hidden;position:relative">
                      ...
                      <div id="rtDanmakuList" class="rt-danmaku-list" style="flex:1;overflow-y:auto;overflow-x:hidden" @scroll="onVsScroll">
                        ...
                        <div v-if="displayedDanmaku.length === 0 && !danmakuLoading" class="empty" style="padding:40px 20px;display:flex;flex-direction:column;align-items:center;justify-content:center;width:100%;min-height:180px">
...
// ========== Virtual Scroll ==========
const VS_ITEM_H = 52   // 预估每项高度(px)
const VS_BUFFER = 10   // 视口上下各多渲染10条
const vsScrollTop = ref(0)
const vsContainerH = ref(500)
const vsTotalH = computed(() => displayedDanmaku.value.length * VS_ITEM_H)
